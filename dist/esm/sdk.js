        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (method === 'GET') {
                    ...
                    const response = yield un.get(url, { params: searchParams, headers: headers });
                    return this.handleReponse(response);
                }
                else {
                    switch (headers['content-type']) {
                        case 'application/json': {
                            const response = yield un.post(url, { headers: headers, data: params });
                            return this.handleReponse(response);
                        }
                        case 'multipart/form-data': {
                            const response = yield un.post(url, { headers: headers, formData: params });
                            return this.handleReponse(response);
                        }
                    }
                }
